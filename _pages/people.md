...
<div style="text-align: center; margin: 30px 0;">
  <img src="{{ base_path }}/images/group_photo.jpg" alt="Group Photo" style="max-width: 60%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
</div>
...
- **Research Interests**: IoT Security \& Deepfake Detection
- **Affiliation**: Zhejiang University
...
- **Research Interests**: Speech Toxicity Detection
- **Affiliation**: Zhejiang University

**Zhengheng Han** (Fall 2024 - present)
- **Research Interests**: Deepfake Detection \& Network Security
- **Affiliation**: Zhejiang University
...
- **Current Position**: Alibaba Group (Beijing)

**Yuexin Wu** (Fall 2020 - Spring 2023)
- **Current Position**: Ant Group (Hangzhou)

**Qiaomu Zheng** (Fall 2021 - Summer 2024)
- **Current Position**: Police Station
...
- **AI-Generated Content Safety \& Security**: Privacy preservation, controllability, authenticity, and compliance
- **Multimodal Data Privacy**: Cross-modal vulnerabilities and privacy-preserving technologies
- **IoT Security**: Smart device security
